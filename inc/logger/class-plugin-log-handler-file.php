 ...
 *
 * @class          Disabler_Log_Handler_File
 */
class Disabler_Log_Handler_File extends Disabler_Log_Handler {
	 ...
	 *         originally used in deprecated Disabler_Logger::add calls.
	 * }
	 *
	...
	public function clear( $handle ) {
		...
		do_action( 'disabler_log_clear', $handle );
	...
	public function remove( $handle ) {
		...
		if ( $file ) {
			...
			do_action( 'disabler_log_remove', $handle, $removed );
		}
	...
	public static function get_log_file_path( $handle ) {
		if ( function_exists( 'wp_hash' ) ) {
			return trailingslashit( DISABLER_LOG_DIR ) . self::get_log_file_name( $handle );
		} else {
			disabler_doing_it_wrong( __METHOD__, __( 'This method should not be called before plugins_loaded.', 'disabler' ), '3.0' );
			return false;
		}
	}
	...
	public static function get_log_file_name( $handle ) {
		if ( function_exists( 'wp_hash' ) ) {
			...
			disabler_doing_it_wrong( __METHOD__, __( 'This method should not be called before plugins_loaded.', 'disabler' ), '3.3' );
			return false;
		}
	}
