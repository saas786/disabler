...
return [
    'rss_feed_redirect'              => [
        ...
        'title'       => static fn() => esc_html__( 'Redirect feeds (if disabled)', 'hbp-disabler' ),
        'type'        => 'select',
    ...
    'disable_feed_global'            => [
        ...
        'title'       => static fn() => esc_html__( 'Disable global feed', 'hbp-disabler' ),
        'type'        => 'checkbox',
        'page'        => 'settings_page_hbp-disabler-settings',
        'section'     => 'feeds',
    ...
    'disable_feed_global_comments'   => [
        ...
        'title'       => static fn() => esc_html__( 'Disable global comment feeds', 'hbp-disabler' ),
        'type'        => 'checkbox',
        'page'        => 'settings_page_hbp-disabler-settings',
        'section'     => 'feeds',
    ...
    'disable_feed_post_comments'     => [
        ...
        'title'       => static fn() => esc_html__( 'Disable post comments feeds', 'hbp-disabler' ),
        'type'        => 'checkbox',
        'page'        => 'settings_page_hbp-disabler-settings',
        'section'     => 'feeds',
    ...
    'disable_feed_authors'           => [
        ...
        'title'       => static fn() => esc_html__( 'Disable post authors feeds', 'hbp-disabler' ),
        'type'        => 'checkbox',
        'page'        => 'settings_page_hbp-disabler-settings',
        'section'     => 'feeds',
    ...
    'disable_feed_post_types'        => [
        ...
        'title'       => static fn() => esc_html__( 'Disable post type feeds', 'hbp-disabler' ),
        'type'        => 'checkbox',
        'page'        => 'settings_page_hbp-disabler-settings',
        'section'     => 'feeds',
    ...
    'disable_feed_categories'        => [
        ...
        'title'       => static fn() => esc_html__( 'Disable category feeds', 'hbp-disabler' ),
        'type'        => 'checkbox',
        'page'        => 'settings_page_hbp-disabler-settings',
        'section'     => 'feeds',
    ...
    'disable_feed_tags'              => [
        ...
        'title'       => static fn() => esc_html__( 'Disable tag feeds', 'hbp-disabler' ),
        'type'        => 'checkbox',
        'page'        => 'settings_page_hbp-disabler-settings',
        'section'     => 'feeds',
    ...
    'disable_feed_custom_taxonomies' => [
        ...
        'title'       => static fn() => esc_html__( 'Disable custom taxonomy feeds', 'hbp-disabler' ),
        'type'        => 'checkbox',
        'page'        => 'settings_page_hbp-disabler-settings',
        'section'     => 'feeds',
    ...
    'disable_feed_search'            => [
        ...
        'title'       => static fn() => esc_html__( 'Disable search results feeds', 'hbp-disabler' ),
        'type'        => 'checkbox',
        'page'        => 'settings_page_hbp-disabler-settings',
        'section'     => 'feeds',
    ...
    'disable_atom_rdf_feeds'         => [
        ...
        'title'       => static fn() => esc_html__( 'Disable Atom / RDF feeds', 'hbp-disabler' ),
        'type'        => 'checkbox',
        'page'        => 'settings_page_hbp-disabler-settings',
        'section'     => 'feeds',
