...
return [
    'disable_texturization' => [
        ...
        'section'     => 'frontend',
        'after_field' => esc_html__( '-- smart quotes (a.k.a. curly quotes), em dash, en dash and ellipsis.', 'hbp-disabler' ),
    ...
    'disable_capital_p'     => [
        ...
        'page'        => 'settings_page_hbp-disabler-settings',
        'section'     => 'frontend',
        'after_field' => esc_html__( 'auto-correction of WordPress capitalization.', 'hbp-disabler' ),
    ...
    'disable_autop'         => [
        ...
        'page'        => 'settings_page_hbp-disabler-settings',
        'section'     => 'frontend',
        'after_field' => esc_html__( '(i.e. <p> tags) from being automatically inserted in your posts.', 'hbp-disabler' ),
    ...
    'disable_shortlinks'    => [
        ...
        'page'        => 'settings_page_hbp-disabler-settings',
        'section'     => 'frontend',
        'after_field' => sprintf( esc_html__( 'Disable links to WordPress\' internal \'shortlink\' URLs for your posts. E.g., %1$s', 'hbp-disabler' ), '<code>' . esc_html( '<link rel="shortlink" href="https://www.example.com/?p=1" />' ) . '</code>' ),
