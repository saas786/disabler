...
class Disabler_Remote_Request {
	...
	public function __construct( $endpoint, array $args = array() ) {
		$this->args['headers'] = array( 
									'user-agent' => 'DisablerTracker/' . md5( esc_url( home_url( '/' ) ) ) . ';', 
	...
	public function send( $method = self::METHOD_POST ) {
		switch ( $method ) {
			...
			default:
				...
				$response = new WP_Error( 1, sprintf( __( 'Request method %1$s is not valid.', '@@textdomain' ), $method ) );
				break;
		}
